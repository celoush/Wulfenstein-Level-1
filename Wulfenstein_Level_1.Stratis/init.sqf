//{_x setDamage 0; _x setUnitPos "UP"} forEach allUnits;
...
0 spawn {
	...
	sekce1_ammo1 addItemCargo ["acc_pointer_IR",1];
	sekce1_ammo2 additemCargoGlobal ["V_Rangemaster_belt",1];
...
0 spawn {
	...
	sekce3_ammo2 additemCargoGlobal ["V_HarnessO_gry",1];
